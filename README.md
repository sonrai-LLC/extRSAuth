...
**:::::NOTE: Big Update:::::** - make sure you set your own username and passphrase in AuthenticationUtilities.cs- these effectively serves as the SSRS v2.0 REST API authenitcation key.
